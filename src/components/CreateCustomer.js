...
const CreateCustomer = () => {
  ...
  const handleCreate = async () => {
    ...
    try {
      await axios.post('http://localhost:5000/customers', newCustomer, { withCredentials: true });
...
return (
  <>
    ...
    <div className="login-container">
      ...
      <button className="login-button" onClick={handleCreate}>Create Customer</button>
    </div>
  </>
);
